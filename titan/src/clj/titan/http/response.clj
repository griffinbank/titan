(ns titan.http.response
  "Http response functions. These are copied verbatim from Metosin's
  ring-http-response and are therefore Copyright Metosin Oy. Code is
  still distributed under the EPL 1.0")
